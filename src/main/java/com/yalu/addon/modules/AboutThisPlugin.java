...
public class AboutThisPlugin extends Module {
    ...
    public void onActivate() {
        ChatUtils.sendMsg(Component.literal("插件作者|译者：食我压路" +
            ...
            "\n如果发现插件翻译不全或出现未翻译的问题请查看版本文件夹根目录下的lang.json文件或自行翻译或上报到github" +
            "\n注意！如果有发现功能名称后面有'[!]'的情况，则说明这个功能尚未翻译，请自行翻译"));
        ChatUtils.sendMsg(Component.literal("点我跳转插件仓库").withStyle(s -> s.withClickEvent(new ClickEvent.OpenUrl(URI.create("https://github.com/xjjakm/Meteor-I18n-Support-plugin/")))));
